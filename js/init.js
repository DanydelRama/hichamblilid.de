...
function foliox_tm_modalbox_portfolio(){
	...
	button.off().on('click',function(){
		...
		modalBox.addClass('opened');
		modalBox.find('.description_wrap').html(content);
		modalBox.find('.popup_details').prepend('<div class="main" data-img-url="'+image+'"></div></div>');
...
function foliox_tm_contact_form(){
	...
	jQuery(".contact_form #send_message").on('click', function(){
		...
		if(name===''||email===''||message===''){
			...
			jQuery.post("https://maghrebwaves.com/assets/inc/contact.php",{ ajax_name: name, ajax_email: email, ajax_message:message, ajax_subject: subject}, function(data) {
